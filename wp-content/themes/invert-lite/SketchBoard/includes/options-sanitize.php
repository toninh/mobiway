...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'invert'),
		'repeat-x'  => __('Repeat Horizontally', 'invert'),
		'repeat-y'  => __('Repeat Vertically', 'invert'),
		'repeat'    => __('Repeat All', 'invert'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'invert'),
		'top center'    => __('Top Center', 'invert'),
		'top right'     => __('Top Right', 'invert'),
		'center left'   => __('Middle Left', 'invert'),
		'center center' => __('Middle Center', 'invert'),
		'center right'  => __('Middle Right', 'invert'),
		'bottom left'   => __('Bottom Left', 'invert'),
		'bottom center' => __('Bottom Center', 'invert'),
		'bottom right'  => __('Bottom Right', 'invert')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'invert'),
		'fixed'  => __('Fixed in Place', 'invert')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'invert'),
		'italic'      => __('Italic', 'invert'),
		'bold'        => __('Bold', 'invert'),
		'bold italic' => __('Bold Italic', 'invert')
		);
